...
public class v1_20_R3 implements MinecraftProtocol {
    ...
    private final Class<?> nbtReadLimiter;
    ...
    public v1_20_R3() throws Exception {
        ...
        this.nbtReadLimiter = getNMSClass("net.minecraft.nbt.NBTReadLimiter");
    ...
    public Object readPlayerData(File file) {
        try {
            return nbtCompressedStreamTools.getMethod("a", Path.class, this.nbtReadLimiter).invoke(null, file.toPath(),
                    this.nbtReadLimiter.getMethod("a").invoke(null));
    ...
    public String readPlayerName(Object playerData) {
        try {
            ...
            return String.valueOf(this.nbtTagString.getMethod("m_").invoke(readNBTValue(playerData, "lastKnownName")));
        } catch(Exception err) { err.printStackTrace(); }
        return "";
    }
    ...
    public Inventory readInventory(Object inventoryData, String owner) {
        ...
        try {
            ...
            for(int x = 0; x < inventoryDataSize; x++) {
                ...
                if((boolean) this.nbtTagCompound.getMethod("g").invoke(stackDataNBT))
                    continue;
    ...
    public void writeToDisk(UUID uid, Object playerData) {
        ...
        try {
            ...
            this.nbtCompressedStreamTools.getMethod("a", this.nbtTagCompound, OutputStream.class)
                    .invoke(null, playerData, new FileOutputStream(tempFile));
