...
public class v1_20_R1 implements MinecraftProtocol {
    ...
    private final Class<?> systemUtils;

    public v1_20_R1() throws Exception {
        ...
        this.systemUtils = getNMSClass("net.minecraft.SystemUtils");
        this.craftItemStack = getNMSClass("org.bukkit.craftbukkit.v1_20_R1.inventory.CraftItemStack");
    }
