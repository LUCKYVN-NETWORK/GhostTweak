...
public class v1_17_R1 implements MinecraftProtocol {
    ...
    public v1_17_R1() throws Exception {
        ...
        this.craftItemStack = getNMSClass("org.bukkit.craftbukkit.v1_17_R1.inventory.CraftItemStack");
    }
    ...
    public String readPlayerName(Object playerData) {
        try {
            ...
            return String.valueOf(this.nbtTagString.getMethod("asString").invoke(readNBTValue(playerData, "lastKnownName")));
        } catch(Exception err) { err.printStackTrace(); }
        return "";
    }
